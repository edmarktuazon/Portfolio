    ...
    <nav class="px-8 xl:px-48" id="navigation">
        <div class="nav-wrapper flex justify-between py-8  lg:mx-0">
            ...
            <ul class="hidden md:flex items-center">
                <li><a href="./index.php" class="text-secondary mr-8 hover:text-white ease-out duration-300">Home</a>
                </li>
                <li><a href="./about/" class="text-secondary mr-8 hover:text-white ease-out duration-300">About</a></li>
                <li><a href="./projects/"
                        class="text-secondary mr-8 hover:text-white ease-out duration-300">Portfolios</a></li>
                <li><a href="./docs/OJT-Cert_Tuazon-Edmark.png"
        ...
        <section class="mobile-menu mx-0">
            <ul class="mt-8 mb-16">
                ...
                <li>
                    ...
                    <a href="./projects/"
                        class="text-secondary mr-8  hover:text-white ease-out duration-300">Portfolios</a>
                </li>
                <hr style="border: 1px solid rgba(255, 255, 255, 0.2); opacity: 0.1;">
                <li>
    ...
    <main>
                ...
                <div class="py-40">
                    <div class="md:block lg:flex lg:items-center">
                        <div class="mx-auto grid place-items-center pb-4 lg:mb-0">
                            <div class="has-tooltip">
                                <div
                                    class='tooltip -mt-6 ml-[170px] lg:ml-[170px] xl:ml-[280px] rounded-sm p-2 flex text-sm text-white bg-backupSecondary text-center '>
                                    Hello there <img src="./assets/img/icons8-waving-hand-emoji-20.png"
                                        alt="wave to visitor"></div>
                                <img src="./assets/img/edmark-circle-img.png"
                                    onmouseover="this.src='./assets/img/edmark-circle-colored-img.png'"
                                    onmouseout="this.src='./assets/img/edmark-circle-img.png'"
                                    class="ml-0  lg:ml-0 xl:ml-28" />
                            </div>
                        </div>
                        <div class="mx-auto">
                            <div
                                ...
                                <h3
                                    class="text-highLight font-[500] text-xl md:text-3xl text-center lg:text-left lg:text-2xl my-4 lg:my-4 ">
                                    Frontend Web Developer</h3>
                                <!-- resume btn -->
                                <a href="./docs/Dev_Ed.pdf"
                                ...
                                <div class="flex m-8">
                                    ...
                                    <div class="pr-4">
                                        <a href="https://www.instagram.com/edmark.ig/">
                                            <img src="./assets/img/akar-icons_instagram-fill.png" alt="instagram"
                                                title="instagram">
                                        </a>
                                    </div>
                                    <div class="pr-4">
                                        <a href="https://www.linkedin.com/in/edmarktuazon/">
                                            <img src="./assets/img/akar-icons_linkedin-box-fill.png" alt="linkedin"
                                                title="linkedin">
                                        </a>
                                    </div>
                                    <a href="https://github.com/edmarktuazon">
                                        <img src="./assets/img/akar-icons_github-fill.png" alt="linkedin"
                                            title="github">
                                    </a>
                                </div>
                            </div>
                    ...
                    <ul class="hidden lg:flex lg:justify-center  animate__animated animate__fadeIn pt-24">
                        <li class="mb-2 md:mb-0">
                            <a href="https://www.facebook.com/edmarktuazon.fb/"
                                class="text-secondary hover:text-white tracking-widest ease-out duration-300">Facebook</a>
                            <span class=" ml-6 mr-6 text-secondary">/</span>
                        </li>
                        <li class="mb-2 md:mb-0"><a href="https://www.instagram.com/edmark.ig/"
                                class="text-secondary  hover:text-white tracking-widest ease-out duration-300">Instagram</a>
                            <span class="ml-6 mr-6 text-secondary">/</span>
                        </li>
                        <li class="mb-2 md:mb-0"><a href="https://www.linkedin.com/in/edmarktuazon/"
                                class="text-secondary  hover:text-white tracking-widest ease-out duration-300">Linkedin</a>
                            <span class="ml-6 mr-6 text-secondary">/</span>
                        </li>
                        <li><a href="https://github.com/edmarktuazon"
                                class="text-secondary mr-8 hover:text-white tracking-widest ease-out duration-300 flip">GitHub</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="my-32">
            <div class="px-8 xl:px-48">
                ...
                <!-- skills -->
                <div
                    class="w-full lg:w-11/12 mx-auto  mt-12 grid grid-cols-3 lg:grid-cols-4 place-items-center item internship-projects gap-12 lg:gap-y-8 lg:gap-x-2">
                    <figure>
                    ...
                    <figure>
                        <img src="./assets/img/icons8-bootstrap-a-free-and-open-source-css-framework-78.png"
                            alt="bootstrap">
                        <figcaption class="text-white capitalize text-center pt-4" data-aos-delay="300"
                            data-aos-duration="1000" data-aos="flip-down">
                            bootstrap
                    ...
                    <figure>
                        ...
                        <figcaption class="text-white capitalize text-center" data-aos-delay="300"
                            data-aos-duration="1000" data-aos="flip-down">
                            tailwind css
                        </figcaption>
                    </figure>
 ...
 opacity: .10; color: inherit;">
        ...
        <footer class="grid grid-cols-1 lg:grid-cols-4 gap-5  px-8 xl:px-48 my-32 ">
            ...
            <div class="mt-8 lg:mt-0 mx-0 lg:mx-auto">
                ...
                <ul class="mt-8">
                    <div class="flex">
                        <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a
                                href="./about/"
                                class="text-secondary mr-8 underline hover:text-white ease-out duration-300">About</a>
                        </p>
                    </div>
                    <div class="flex">
                        <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a
                                href="./contact/"
                                class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Contact</a>
                        </p>
                    </div>
                    <div class="flex">
                        <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a
                                href="./projects/"
                                class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Portfolios</a>
                        </p>
                    </div>
                </ul>
            </div>
            <div class="mt-8 lg:mt-0">
                ...
                <ul class="mt-8">
                    <div class="flex">
                        <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a
                                href="./docs/OJT-Cert_Tuazon-Edmark.png"
                                class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Certificates</a>
                        </p>
                    </div>
                    <div class="flex">
                        <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a
                                href="./docs/Dev_Ed.pdf"
                                class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Resume</a>
                        </p>
                    </div>
                </ul>
            </div>
            <div class="mt-8 lg:mt-0 ">
                ...
                <ul class="mt-8">
                    <div class="flex">
                        ...
                        <p class="mb-2"><a href="mailto:edmarktuazon03@gmail.com"
                                class="text-secondary underline hover:text-white ease-out duration-300 ">edmarktuazon03@gmail.com</a>
                        </p>
                    </div>
                    <div class="flex">
        ...
        <!-- secondary footer -->
        <footer class="h-20 bg-backupSecondary flex items-center justify-center"
            style="background-color:#161719; height: 80px;">
