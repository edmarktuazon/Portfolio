...
<footer class="grid grid-cols-1 lg:grid-cols-4 gap-5  px-8 xl:px-48 my-32 ">
    ...
    <div class="mt-8 lg:mt-0 mx-0 lg:mx-auto">
        ...
        <ul class="mt-8">
            <div class="flex">
                <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a href="../index.php" class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Home</a></p>
            </div>
            <div class="flex">
    ...
    <div class="mt-8 lg:mt-0 ">
        ...
        <ul class="mt-8">
            <div class="flex">
                <p class="mb-2"> <i class="fa-solid fa-angle-right pr-2 text-white hover:text-white"></i><a href="../docs/OJT-Cert_Tuazon-Edmark.png" class="text-secondary mr-8 underline hover:text-white ease-out duration-300">Certificate</a></p>
            </div>
            <div class="flex">
    ...
    <div class="mt-8 lg:mt-0">
        ...
        <ul class="mt-8">
            <div class="flex">
                ...
                <p class="mb-2"><a href="mailto:edmarktuazon03@gmail.com" class="text-secondary hover:text-white  underline ease-out duration-300">edmarktuazon03@gmail.com</a></p>
            </div>
            <div class="flex">
