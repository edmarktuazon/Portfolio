 <section class="my-32 ">
     ...
     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-8 lg:px-36">
         ...
         <div class="owl-carousel owl-theme">
             ...
             <div class="item">
                 <i class="fa-solid fa-quote-right text-white text-4xl pb-4"></i>
                 <p class="text-secondary pb-4">Edmark is very easy to work with and he helped breathe life into
                     the concepts I had designed! I highly recommend him since he's able to produce quality
                     outputs even in a short amount of time. Working with him, I also learned new things along
                     the way and he offered good suggestions which improved the website as a whole.
                 </p>
                 <div class="group flex items-center">
                     <!-- <img class="shrink-0 h-12 w-12 rounded-full" src="./assets/img/client-feedback-02.png" alt="client-02-img" /> -->
                     <div class="block">
                         <h4 class="text-white capitalize text-3xl pb-2">Nicole Pajarin</h4>
                         <p class="text-secondary capitalize text-sm">3D Artist, Voice Actor</p>
                     </div>
                 </div>
             </div>
         </div>
