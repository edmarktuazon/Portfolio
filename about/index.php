        ...
        <section class="bg-backupSecondary" style="background-color:#161719;">
            <div class="px-8 xl:px-48 flex items-center">
                <div class="my-52 animate__animated animate__fadeInDown">
                    <h2 class="font-bold text-[44px] lg:text-6xl xl:text-6xl tracking-wider text-white pb-4">A little About me</h2>
            ...
            <div class="px-8 xl:px-48">
                ...
                <div class="w-full lg:w-11/12 mx-auto  mt-12 grid grid-cols-3 lg:grid-cols-4 place-items-center item internship-projects gap-12 lg:gap-y-8 lg:gap-x-2">
                    <figure>
                        ...
                        <figcaption class="text-white uppercase text-center pt-4" data-aos-delay="300" data-aos-duration="1000" data-aos="flip-down">
                            html
                        </figcaption>
                    </figure>
                    <figure>
                    ...
                    <figure>
                        ...
                        <figcaption class="text-white uppercase text-center" data-aos-delay="300" data-aos-duration="1000" data-aos="flip-down">
                            tailwind css
                        </figcaption>
                    </figure>
                    <figure>
